            ...
            <div class="s3d-flat-dashboard__info-details">
                    ${
                      showPrices
                        ...
                        <span class="text-style-3-d-fonts-1920-h-1">
                            ${i18n.t('currency_label') === '$' ? `${i18n.t('currency_label')} ${numberWithCommas(flat.price)} ` : `${numberWithCommas(flat.price)}  ${i18n.t('currency_label')}`}
                    ...
                    <div class="s3d-flat-dashboard__info-details-item s3d-flat-dashboard__info-item--mobile-row">
                        <span class="text-style-3-d-fonts-1920-h-1">
                            ${Object.values(flat.customProperties)?.find(prop => prop?.value.crm_properties_id == 52)?.value.value}
                        </span>
                        <span class="text-style-3-d-fonts-1920-body-regular">
