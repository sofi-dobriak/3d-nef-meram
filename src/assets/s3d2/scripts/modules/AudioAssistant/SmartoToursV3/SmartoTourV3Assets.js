...
export default class SmartoTourV3Assets {
    ...
    getSceneCssInfoHotspot({
        ...
        return `
            <div data-scene-id="${hotspot.source_scene_id}" data-hotspot-index="${index}" class="hotspot-label hotspot-label--info hidden" id="${safeId}" ${isTouchDevice ? '' : changeSceneAttribute}>
    ...
    getScene(children = '') {
        return `
            <a-scene 
                ...
                data-smarto-tours-v3-a-frame-scene 
                embedded
