...
const ensureAframeLoaded = async () => {
    ...
    const aframeModule = await import(
        /* webpackChunkName: "aframe" */ 'aframe'
    );
    ...
    await import(
        /* webpackChunkName: "aframe-troika-text" */ 'aframe-troika-text'
    );
    ...
    renderSceneHotSpots() {
        ...
        document.querySelectorAll('.collidable').forEach(el => {
            ...
            el.addEventListener('mouseenter', () => {
                ...
                this.$container.querySelectorAll(`[data-hotspot-preview-image="${el.getAttribute('data-scene')}"]`).forEach(img => {
                    img.setAttribute('visible', true);
                });
            });
