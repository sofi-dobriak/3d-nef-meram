export default function s3d2_FilterButton(text, additionalClasses = '') {
  return `
    <button type="button" class="js-ctr-btn js-s3d-ctr__filter s3d2-filter-call-button ${additionalClasses}">
